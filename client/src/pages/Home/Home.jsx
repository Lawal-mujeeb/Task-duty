    ...
    <>
      <main className=" w-full bg-white min-h-screen flex items-center">
        <div className="container mx-auto grid grid-cols-12 px-4 lg:px-20   ">
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center items-center lg:items-start gap-6">
            
            <h1 className="text-4xl font-bold mb-4 mt-3 md:mt-0 text-center lg:text-left lg:w-[70%]">
              Manage your Task on{" "}
