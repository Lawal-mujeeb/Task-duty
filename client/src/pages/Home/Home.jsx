  ...
  return (
    <>
      <main className="w-full bg-white min-h-screen flex items-center">
        <div className="container mx-auto grid grid-cols-12 px-4 lg:px-0   ">
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center gap-6">
            ...
            <button className="border-2 border-blue-600 text-blue-600 px-6 py-2 rounded hover:bg-blue-600 hover:text-white transition md:w-[30%] md:mx-auto lg:mx-0">
              <Link to="/alltask">Go to my task</Link>
            </button>
          </div>
