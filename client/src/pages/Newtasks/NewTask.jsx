...
export default function TaskForm({ initialData, onSubmit }) {
  ...
  return (
      <div className="mx-auto max-w-[1100px] px-4 mt-15 ">
               <h1 className="font-semibold text-2xl"><Link to="/alltask"> &lt; New Task</Link></h1> 
    ...
    <form onSubmit={handleSubmit}>
     ...
     <Link to="/tasks" className=" flex justify-center mt-15 mb-10 underline">  Back To Top </Link>
    </div>
  );
}